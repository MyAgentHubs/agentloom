// T6E2: 桌面 i18n 文案表——零依赖模块（禁止 import 任何东西）。
// 从 app/src/i18n.tsx 逐字节搬出，供桌面 + Web(C1) 共享消费。
export const messages = {
  ...
  en: {
    ...
    "updater.about.disabled.dev":
      "In-app updates aren't available in dev builds",
    ...
    "updater.recovery.title":
      "Update didn't complete · running the backup copy",
    "updater.recovery.body":
    ...
    "backend.updater.check_failed":
      "Check for updates failed — try again later",
