...
import { useSearchTargetScroll } from "../hooks/useSearchTargetScroll";
import { blockWeight } from "../lib/blockWeight";
  ...
  return (
    ...
    >
      ...
      <MessageContent
        ...
        verbosity={verbosity}
        sessionId={sessionId}
        autoInlineImagePaths={message.role === "assistant"}
        onViewRun={onViewRun}
        onUndoRun={onUndoRun}
